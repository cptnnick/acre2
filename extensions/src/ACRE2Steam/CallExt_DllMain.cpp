...
void __stdcall RVExtension(char *output, int outputSize, const char *function)
{
    ...
    switch(command) {
        ...
        case STEAM_DO_COPY: {
            ...
            //Pre-Teamspeak 3.1 locations - Registry read-able
            ...
            if (!found) {
                int result = MessageBoxA(NULL, "ACRE was unable to find a Teamspeak 3 installation. If you do have installation please copy the plugins yourself or reinstall Teamspeak. Continue anyway?", "ACRE Installation Error", MB_YESNO | MB_ICONEXCLAMATION);
                if (result == IDYES) {
